...
class _RoomsViewState extends State<RoomsView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [_roomList(app), const SizedBox(height: 18), _roomDetail(app)],
    );
  }
        ...
        children: [
              ...
              child: Column(
                children: [
                  ...
                  VGradientButton(
                    ...
                    fullWidth: true,
                    onTap: _titleC.text.trim().isEmpty
                        ? null
                        : () {
                            app.createRoom(
                              title: _titleC.text,
          ...
          if (app.liveRooms.isEmpty)
            ...
            ...app.liveRooms.map((room) {
              final host = app.profiles.firstWhere(
                (p) => p.id == room.hostId,
                orElse: () => Profile(
                  id: '',
                  fullName: 'Host',
  ...
  Widget _roomDetail(AppProvider app) {
    ...
    if (room == null) {
      return VPanel(
        child: const VEmptyState(
          ...
          body: 'Create a room or join one from the list.',
        ),
      );
    }
    ...
    final roomGames = app.gameSessions
        .where((g) => g.roomId == room.id && g.isActive)
        .toList();
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Column(
                children: [
                  VSecondaryButton(
                    label: myP != null ? 'Joined' : 'Join',
                    icon: Icons.login,
                    onTap: myP != null ? null : () => app.joinRoom(room),
                  ),
                  const SizedBox(height: 8),
                  VDangerButton(
                    label: 'Leave',
                    icon: Icons.logout,
                    onTap: () => app.leaveRoom(room),
                  ),
                ],
              ),
            ],
          ...
          VVoiceChatBubble(
            ...
            joined: myP != null,
            onJoin: myP != null ? null : () => app.joinRoom(room),
          ),
          const SizedBox(height: 14),
          VoiceConsole(
            room: room,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Icon(
                      ...
                      size: 16,
                      color: p.muted ? VoxoraColors.muted : VoxoraColors.online,
                    ),
                  ],
                ),
              );
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    VSecondaryButton(
                      label: 'View all',
                      onTap: () => app.setView(AppView.games),
                    ),
                  ],
                ),
                const SizedBox(height: 12),
                Wrap(
                  spacing: 8,
                  children: ['chess', 'ludo', 'cards']
                      .map(
                        (g) => OutlinedButton.icon(
                          onPressed: myP == null
                              ? null
                              : () => app.createGame(room.id, g),
              ...
              children: [
                Container(
                  ...
                  decoration: const BoxDecoration(
                    border: Border(
                      bottom: BorderSide(color: VoxoraColors.line),
                    ),
                  ),
                  child: Row(
                    children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      VGradientIconButton(
                        icon: Icons.send,
                        onTap: myP == null || _chatC.text.trim().isEmpty
                            ? null
                            : () {
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              OutlinedButton.icon(
                onPressed: () async {
                  final base = appPublicUrl.endsWith('/')
                      ? appPublicUrl
                      : '$appPublicUrl/';
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    color: n.isDone
                        ? VoxoraColors.success.withValues(alpha: 0.08)
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${n.profile?.fullName ?? "Member"} · ${_formatTime(n.createdAt)}',
                              style: Theme.of(context).textTheme.bodySmall,
                            ),
                          ],
                        ),
          ...
          if (visible.isEmpty)
            Padding(
              ...
              child: Text(
                'No ${tabs[_meetingTab]?.toLowerCase()} yet.',
                style: Theme.of(context).textTheme.bodySmall,
              ),
            ),
          const SizedBox(height: 8),
            ...
            children: [
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: myP != null
                        ? 'Add ${tabs[_meetingTab]?.toLowerCase()}...'
                        : 'Join to add notes',
                    contentPadding: const EdgeInsets.symmetric(
                      horizontal: 14,
                      vertical: 10,
              ...
              VGradientIconButton(
                icon: Icons.add,
                onTap: myP == null || _noteC.text.trim().isEmpty
                    ? null
                    : () {
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _voice.enabled
                  ? VoxoraColors.cyan.withValues(alpha: 0.4)
                  : VoxoraColors.line,
            ),
            gradient: LinearGradient(
              colors: _voice.enabled
                  ? [
                      VoxoraColors.cyan.withValues(alpha: 0.12),
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: _voice.enabled
                          ? (_voice.muted
                                ...
                                : VoxoraColors.online.withValues(alpha: 0.15))
                          : VoxoraColors.surfaceLight,
                      border: Border.all(
                        color: _voice.enabled
                            ? (_voice.muted
                                  ? VoxoraColors.lime.withValues(alpha: 0.3)
                                  : VoxoraColors.online.withValues(alpha: 0.3))
                            : VoxoraColors.line,
                      ),
                    ),
                    child: Row(
